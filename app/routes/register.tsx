            ...
            <div className="relative z-10 bg-white/95 backdrop-blur-sm px-8 py-10 rounded-2xl shadow-2xl w-full max-w-sm flex flex-col gap-12">
                ...
                <div>
                    ...
                    <button
                        ...
                        className={`${buttonDisabled() ? "cursor-not-allowed bg-slate-200 text-gray-500" : "bg-blue-500 text-white hover:bg-blue-600"} w-full py-2 rounded-full  transition-colors flex items-center justify-center`}
                    >
